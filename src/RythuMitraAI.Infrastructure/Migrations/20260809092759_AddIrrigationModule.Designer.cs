...
namespace RythuMitraAI.Infrastructure.Migrations
{
    ...
    [Migration("20260809092759_AddIrrigationModule")]
    partial class AddIrrigationModule
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("RythuMitraAI.Domain.Entities.Disease", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("RythuMitraAI.Domain.Entities.Irrigation", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<string>("IrrigationCode")
                        .IsRequired()
                        .HasMaxLength(50)
                        .HasColumnType("nvarchar(50)");
                    ...
                    b.HasIndex("IrrigationCode")
                        .IsUnique();

                    b.HasIndex("IrrigationDate");

                    b.ToTable("Irrigations", (string)null);
                });
            ...
            modelBuilder.Entity("RythuMitraAI.Domain.Entities.Irrigation", b =>
                {
                    b.HasOne("RythuMitraAI.Domain.Entities.Crop", null)
                        .WithMany()
