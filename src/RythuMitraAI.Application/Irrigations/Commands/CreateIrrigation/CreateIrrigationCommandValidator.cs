...
/// <summary>
/// Validator for <see cref="CreateIrrigationCommand"/>.
/// </summary>
public sealed class CreateIrrigationCommandValidator : AbstractValidator<CreateIrrigationCommand>
{
    public CreateIrrigationCommandValidator()
    {
        RuleFor(x => x.Request).NotNull().WithMessage("Create irrigation request is required.");
